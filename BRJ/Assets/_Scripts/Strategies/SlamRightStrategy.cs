...
public class SlamRightStrategy : IStrategy
{
    ...
    public void Execute(Client client, UnityAction callback = null)
    {
        ...
        m_animator.SetTrigger("slamRight");
    }

    public SlamRightStrategy(Client client, GameObject hazardAreaPrefab, Vector3 offset, float slamMagnitude, string tag = "", Action<object[]> onCollision = null)
    {
        m_client = client;
