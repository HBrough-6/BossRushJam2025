...
public class SlamLeftStrategy : IStrategy
{
    ...
    public void Execute(Client client, UnityAction callback = null)
    {
        ...
        m_animator.SetTrigger("slamLeft");
    }

    public SlamLeftStrategy(Client client, GameObject hazardAreaPrefab, Vector3 offset, float slamMagnitude, string tag = "", Action<object[]> onCollision = null)
    {
        m_client = client;
